...
- **Wiktor Mlynarski** — 5 lectures (first half)
- **Anton Sirota** — 5 lectures (second half)

## Teaching assistants (2026 cohort)

- **Arash Shahidi** (Sirota lab)
- **Jonathan Gant** (Mlynarski lab)

## Where things live

- **[Quick start](quickstart.md)** — start here on day 1
- **[Schedule](schedule.md)** — week-by-week lectures + exercise deadlines
- **[Setup](setup/ssh.md)** — SSH, VS Code, conda, HPC workspace
- **[Lectures](lectures.md)** — slide PDFs (shared via LMU Biology cloud, see below)
