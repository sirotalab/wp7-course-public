...
```bash
conda activate wp7
mkdir -p ~/<slug>/ex6 && cd ~/<slug>/ex6
cp /storage2/wp7/course-materials/exercises/ex6-dimred/starter.ipynb ex6_<slug>.ipynb
```

Check the exercise `README.md` for data paths and tips. The prompt PDF (`ex6.pdf`) is in the same directory.
